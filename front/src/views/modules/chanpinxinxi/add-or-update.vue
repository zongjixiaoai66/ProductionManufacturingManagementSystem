<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="产品特色" prop="chanpintese">
          <el-input v-model="ruleForm.chanpintese" 
              placeholder="产品特色" clearable  :readonly="ro.chanpintese"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="产品特色" prop="chanpintese">
              <el-input v-model="ruleForm.chanpintese" 
                placeholder="产品特色" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="产品规格" prop="chanpinguige">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chanpinguige" 
                type="date"
                :readonly="ro.chanpinguige"
                placeholder="产品规格">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chanpinguige" label="产品规格" prop="chanpinguige">
              <el-input v-model="ruleForm.chanpinguige" 
                placeholder="产品规格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.chanpinguige = this.getCurDate()
  ...
  methods: {
	...
	this.ruleForm.chanpinshuoming = this.ruleForm.chanpinshuoming.replace(reg,'../../../springboot55nqb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
