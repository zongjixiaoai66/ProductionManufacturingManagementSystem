<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="部门负责人" prop="bumenfuzeren">
          <el-input v-model="ruleForm.bumenfuzeren" 
              placeholder="部门负责人" clearable  :readonly="ro.bumenfuzeren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="部门负责人" prop="bumenfuzeren">
              <el-input v-model="ruleForm.bumenfuzeren" 
                placeholder="部门负责人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="办公区域" prop="bangongquyu">
          <el-input v-model="ruleForm.bangongquyu" 
              placeholder="办公区域" clearable  :readonly="ro.bangongquyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="办公区域" prop="bangongquyu">
              <el-input v-model="ruleForm.bangongquyu" 
                placeholder="办公区域" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
