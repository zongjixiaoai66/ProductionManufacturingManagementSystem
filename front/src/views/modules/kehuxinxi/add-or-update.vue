<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客户等级" prop="kehudengji">
          <el-input v-model="ruleForm.kehudengji" 
              placeholder="客户等级" clearable  :readonly="ro.kehudengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客户等级" prop="kehudengji">
              <el-input v-model="ruleForm.kehudengji" 
                placeholder="客户等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dizhi = true;
          ...
          if(o=='kehudengji'){
            this.ruleForm.kehudengji = obj[o];
	    this.ro.kehudengji = true;
            continue;
          }
