<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物料规格" prop="wuliaoguige">
          <el-input v-model="ruleForm.wuliaoguige" 
              placeholder="物料规格" clearable  :readonly="ro.wuliaoguige"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物料规格" prop="wuliaoguige">
              <el-input v-model="ruleForm.wuliaoguige" 
                placeholder="物料规格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="物料详情" prop="wuliaoxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wuliaoxiangqing" label="物料详情" prop="wuliaoxiangqing">
                    <span v-html="ruleForm.wuliaoxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wuliaoleixing = true;
          ...
          if(o=='wuliaoguige'){
            this.ruleForm.wuliaoguige = obj[o];
	    this.ro.wuliaoguige = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.wuliaoxiangqing = this.ruleForm.wuliaoxiangqing.replace(reg,'../../../springboot55nqb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
