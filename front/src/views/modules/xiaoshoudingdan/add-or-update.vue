<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总销售额" prop="zongxiaoshoue">
            <el-input v-model="zongxiaoshoue"
                placeholder="总销售额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zongxiaoshoue" label="总销售额" prop="zongxiaoshoue">
              <el-input v-model="ruleForm.zongxiaoshoue" 
                placeholder="总销售额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="销售时间" prop="xiaoshoushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiaoshoushijian" label="销售时间" prop="xiaoshoushijian">
              <el-input v-model="ruleForm.xiaoshoushijian" 
...
export default {
  ...
  computed: {
    ...
    zongxiaoshoue:{
      get: function () {
        return 1*this.ruleForm.jiage*this.ruleForm.xiaoshoushuliang
      }
    },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoshoushuliang = true;
          ...
          if(o=='zongxiaoshoue'){
            this.ruleForm.zongxiaoshoue = obj[o];
	    this.ro.zongxiaoshoue = true;
            continue;
          }
    ...
    // 提交
    onSubmit() {
        this.ruleForm.zongxiaoshoue = this.zongxiaoshoue
